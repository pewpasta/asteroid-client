...
public class Capes {
    ...
    public static void init() {
        ...
        AsteroidClient.EVENT_BUS.subscribe(Capes.class);
    }
    ...
    private static class Cape extends Identifier {
        ...
        public Cape(String name) {
            super("asteroid-client", "capes/" + COUNT++);
        ...
        public void register() {
            AsteroidClient.mc.getTextureManager().registerTexture(this, new NativeImageBackedTexture(img));
            img = null;
