...
import RewardedIvan.asteroidclient.utils.player.FindItemResult;
import RewardedIvan.asteroidclient.utils.player.InvUtils;
...
public class BlockUtils {
    ...
    public static void init() {
        AsteroidClient.EVENT_BUS.subscribe(BlockUtils.class);
    }
