...
import RewardedIvan.asteroidclient.mixininterface.IMatrix4f;
...
public class RenderUtils {
    ...
    public static void drawItem(ItemStack itemStack, int x, int y, double scale, boolean overlay) {
        ...
        AsteroidClient.mc.getItemRenderer().renderGuiItemIcon(itemStack, (int) (x / scale), (int) (y / scale));
        if (overlay) AsteroidClient.mc.getItemRenderer().renderGuiItemOverlay(AsteroidClient.mc.textRenderer, itemStack, (int) (x / scale), (int) (y / scale), null);
