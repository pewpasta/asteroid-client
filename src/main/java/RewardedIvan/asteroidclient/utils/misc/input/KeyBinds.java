...
package RewardedIvan.asteroidclient.utils.misc.input;

import RewardedIvan.asteroidclient.mixin.KeyBindingAccessor;
...
public class KeyBinds {
    ...
    public static KeyBinding OPEN_GUI = new KeyBinding("key.asteroid-client.open-gui", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_RIGHT_SHIFT, CATEGORY);
    public static KeyBinding OPEN_COMMANDS = new KeyBinding("key.asteroid-client.open-commands", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_PERIOD, CATEGORY);
