...
package RewardedIvan.asteroidclient.systems.config;

import RewardedIvan.asteroidclient.AsteroidClient;
import RewardedIvan.asteroidclient.renderer.Fonts;
...
public class Config extends System<Config> {
    ...
    public final Setting<String> font = sgVisual.add(new ProvidedStringSetting.Builder()
        .name("font")
        .description("Custom font to use (picked from .minecraft/" + AsteroidClient.MOD_ID + "/fonts folder).")
    ...
    public final Setting<Boolean> customWindowTitle = sgVisual.add(new BoolSetting.Builder()
        ...
        .defaultValue(false)
        .onModuleActivated(setting -> AsteroidClient.mc.updateWindowTitle())
        .onChanged(value -> AsteroidClient.mc.updateWindowTitle())
        .build()
    );
    ...
    public final Setting<Boolean> chatFeedback = sgChat.add(new BoolSetting.Builder()
        .name("chat-feedback")
        .description("Sends chat feedback when asteroid performs certain actions.")
        .defaultValue(true)
        .build()
    );
    ...
    public NbtCompound toTag() {
        ...
        tag.putString("version", AsteroidClient.VERSION.toString());
