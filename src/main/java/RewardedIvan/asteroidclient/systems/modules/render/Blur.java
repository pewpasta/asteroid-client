...
import RewardedIvan.asteroidclient.renderer.Framebuffer;
...
public class Blur extends Module {
    ...
    public Blur() {
        ...
        AsteroidClient.EVENT_BUS.subscribe(new ConsumerListener<>(WindowResizedEvent.class, event -> {
            if (fbo1 != null) {
                fbo1.resize();
                fbo2.resize();
            }
        ...
        AsteroidClient.EVENT_BUS.subscribe(new ConsumerListener<>(RenderAfterWorldEvent.class, event -> onRenderAfterWorld()));
    }
