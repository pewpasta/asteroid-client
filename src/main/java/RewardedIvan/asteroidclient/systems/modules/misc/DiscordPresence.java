...
//Created by squidoodly and RewardedIvan
...
public class DiscordPresence extends Module {
    ...
    public void onActivate() {
        ...
        String largeText = "Asteroid Client " + AsteroidClient.VERSION;
        if (!AsteroidClient.DEV_BUILD.isEmpty()) largeText += " Dev Build: " + AsteroidClient.DEV_BUILD;
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (Utils.canUpdate()) {
            ...
            if (!lastWasInMainMenu) {
                rpc.setDetails("Meteor Client " + (AsteroidClient.DEV_BUILD.isEmpty() ? AsteroidClient.VERSION : AsteroidClient.VERSION + " " + AsteroidClient.DEV_BUILD));
