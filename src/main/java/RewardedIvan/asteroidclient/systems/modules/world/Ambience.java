...
package RewardedIvan.asteroidclient.systems.modules.world;
...
/**
 * this should be in render, but i will keep it here. - RewardedIvan
 * @author Walaryne
 */
public class Ambience extends Module {
    ...
    public SettingColor skyColor() {
        switch (PlayerUtils.getDimension()) { //for some reason, this doesn't work with Dimension.blahblahblah. WHY?? - RewardedIvan
            case Overworld -> {
