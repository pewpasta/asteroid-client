...
import RewardedIvan.asteroidclient.mixin.BufferRendererAccessor;
import RewardedIvan.asteroidclient.mixininterface.ICapabilityTracker;
...
public class GL {
    ...
    public static void bindTexture(Identifier id) {
        ...
        AsteroidClient.mc.getTextureManager().bindTexture(id);
    }
