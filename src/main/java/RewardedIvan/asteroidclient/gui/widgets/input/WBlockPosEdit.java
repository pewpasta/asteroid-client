...
package RewardedIvan.asteroidclient.gui.widgets.input;
...
import RewardedIvan.asteroidclient.events.entity.player.InteractBlockEvent;
import RewardedIvan.asteroidclient.events.entity.player.StartBreakingBlockEvent;
    ...
    public void init() {
        ...
        if (Utils.canUpdate()) {
            ...
            click.action = () -> {
                ...
                clicking = true;
                AsteroidClient.EVENT_BUS.subscribe(this);
