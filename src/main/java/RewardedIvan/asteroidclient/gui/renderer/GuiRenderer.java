...
import RewardedIvan.asteroidclient.gui.renderer.operations.TextOperation;
import RewardedIvan.asteroidclient.gui.renderer.packer.GuiTexture;
import RewardedIvan.asteroidclient.gui.renderer.packer.TexturePacker;
...
import RewardedIvan.asteroidclient.utils.render.ByteTexture;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(new Identifier("asteroid-client", "textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(new Identifier("asteroid-client", "textures/icons/gui/triangle.png"));
        EDIT = addTexture(new Identifier("asteroid-client", "textures/icons/gui/edit.png"));
        RESET = addTexture(new Identifier("asteroid-client", "textures/icons/gui/reset.png"));
        FAVORITE_NO = addTexture(new Identifier("asteroid-client", "textures/icons/gui/favorite_no.png"));
        FAVORITE_YES = addTexture(new Identifier("asteroid-client", "textures/icons/gui/favorite_yes.png"));
